<?php  //[STAMP] 7666f9ffbad60c226c1d5c58869af71c
...
trait FunctionalTesterActions
{
     ...
     * @see \Helper\Functional::sha256()
     */
    public function sha256($data) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sha256', func_get_args()));
    }
     ...
     * @param string $source
     * @return string
     * @see \Helper\Functional::createFingerPrint()
     */
    public function createFingerPrint($apikey, $secret, $timestamp, $method, $resourceUri, $nric, $amount, $date, $source) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createFingerPrint', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Functional::retrieveUserInfo()
     */
    public function retrieveUserInfo($queryValue, $column = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('retrieveUserInfo', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Functional::retrieveSharedSecret()
     */
    public function retrieveSharedSecret($apikey) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('retrieveSharedSecret', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Functional::retrieveSource()
     */
    public function retrieveSource($apikey) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('retrieveSource', func_get_args()));
    }
